...
You also have to activate the virtual environment to use it. Activate using:
...
3. [Initialize Poetry and a `pyproject.toml` file in a project](https://python-poetry.org/docs/basic-usage/#initialising-a-pre-existing-project)
